        ...
        <div className="flex flex-col gap-6 p-6 pt-14 sm:p-8 sm:pt-8">
          ...
          <div className="flex items-start gap-4 pr-10">
            {foto ? (
              ...
              <span
                aria-hidden="true"
                className="grid h-16 w-16 shrink-0 place-items-center rounded-full border border-line-accent bg-accent/10 font-mono text-sm font-semibold text-accent-ink shadow-inner-top"
              >
          ...
          {enlace ? (
            <a
              ...
              className="inline-flex w-fit items-center gap-1.5 text-sm font-medium text-accent-ink transition-colors duration-200 hover:text-accent-bright"
            >
              {testimonial.name}
