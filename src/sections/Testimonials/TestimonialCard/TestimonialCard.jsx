    ...
    <Reveal as="figure" variants={scaleIn} delay={index * 0.08} className={`min-w-0 ${className}`}>
      <SpotlightCard className="flex h-full flex-col gap-4 p-6 md:p-7">
        ...
        <div className="pointer-events-none relative z-[1] flex flex-1 flex-col gap-4">
          ...
          <span className="inline-flex w-fit items-center gap-1.5 text-sm font-medium text-accent-ink underline decoration-transparent underline-offset-4 transition-all duration-200 group-hover:text-accent-bright group-hover:decoration-current">
            {t('actions.readFull')}
            <ICONS.arrowUpRight
              aria-hidden="true"
          ...
          <figcaption className="flex items-center gap-3 border-t border-line pt-5">
            {foto ? (
              ...
              <span
                aria-hidden="true"
                className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-line-accent bg-accent/10 font-mono text-xs font-semibold text-accent-ink shadow-inner-top"
              >
              ...
              <span className="flex items-center gap-1.5 text-sm font-semibold text-ink">
                ...
                {enlace ? (
                  <a
                    ...
                    className="pointer-events-auto shrink-0 text-ink-subtle transition-colors duration-200 hover:text-accent-ink"
                  >
