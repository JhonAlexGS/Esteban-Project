      ...
      <motion.div style={parallax} className="nc-container">
        ...
        >
          ...
          <div className="flex min-w-0 flex-col items-start gap-6 md:gap-8">
            ...
            <motion.span
              variants={item}
              className="inline-flex items-center gap-2.5 rounded-full border border-line-accent bg-accent/10 py-1.5 pr-4 pl-3 font-mono text-[0.6875rem] tracking-widest text-accent-ink uppercase shadow-inner-top"
            >
