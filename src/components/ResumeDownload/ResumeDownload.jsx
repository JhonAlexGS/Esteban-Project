...
const ARCHIVOS = [
  {
    id: 'standard',
    archivo: 'cv/Esteban-Jordan-CV.pdf',
    // Nombre con el que se guarda en el equipo de quien lo descarga.
    nombreDescarga: 'Esteban Jordan - CV.pdf',
  },
  {
    id: 'ats',
    archivo: 'cv/Esteban-Jordan-CV-ATS.pdf',
    nombreDescarga: 'Esteban Jordan - CV (ATS).pdf',
  },
]
            ...
            {disponibles.map((item) => (
              <li key={item.id}>
                ...
                >
                  ...
                  <ICONS.download aria-hidden="true" className="h-4 w-4 shrink-0 text-accent-ink" />
                </motion.a>
              </li>
            ))}
          </motion.ul>
