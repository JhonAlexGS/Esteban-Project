...
const COMPONENTS = {
  ...
  a: ({ href, children }) => (
    <a
      ...
      className="font-medium text-accent-ink underline decoration-line-accent underline-offset-4 transition-colors duration-200 hover:text-accent-bright hover:decoration-accent"
    >
      {children}
    </a>
  ),
  ...
  li: ({ children }) => (
    <li className="relative pl-6 text-base leading-relaxed text-ink-muted marker:text-accent-ink">
      <span
        aria-hidden="true"
