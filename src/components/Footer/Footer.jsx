      ...
      <div className="nc-container grid gap-10 py-14 md:grid-cols-[1.5fr_1fr_1fr] md:py-16">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2.5">
            <span className="grid h-9 w-9 place-items-center rounded-xl border border-line-accent bg-accent/10 font-mono text-xs font-semibold text-accent-ink shadow-inner-top">
              {profile.initials}
            </span>
